...
oc apply -f install\kubernetes\helm\istio\templates\crds.yaml
...
del depl_v1.yml
C:\Users\Hugo\Documents\Code\java\istio-1.0.4\bin\istioctl.exe kube-inject -f ..\..\kubernetes\Deployment.yml > depl_v1.yml
...
del depl_v2.yml
C:\Users\Hugo\Documents\Code\java\istio-1.0.4\bin\istioctl.exe kube-inject -f ..\..\kubernetes\Deployment-v2.yml > depl_v2.yml
